 ...
 */
class LazyReferenceStrategy implements StrategyInterface
{
     ...
     * @param mixed $value
     */
    protected function createDelegate($value)
    {
        return new LoadReferenceDelegate($this->repository, $this->entityType, $value, $this->ensureType);
    }
