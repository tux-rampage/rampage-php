...
namespace rampage\core\xml\exception;

use rampage\core\exception\ExceptionInterface as CoreExceptionInterface;

/**
 * Exception interface for grouping xml exceptions
 */
