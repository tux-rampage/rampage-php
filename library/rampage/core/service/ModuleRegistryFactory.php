...
/**
 * Modukle registry factory
 */
class ModuleRegistryFactory
{
    /**
     ...
     */
    public function __invoke(ServiceLocatorInterface $locator, $name, $requestedName)
    {
        $registry = new ModuleRegistry($locator->get('rampage.PathManager'));
        return $registry;
    }
}